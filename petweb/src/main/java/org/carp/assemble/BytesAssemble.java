...
public class BytesAssemble extends AbstractAssemble{
	...
	public Object setFieldValue(ResultSet rs, Object entity, Field f, int index)
			throws Exception {
		Object value = rs.getBytes(index);
		this.setFieldValue(entity, f, value);
		return value;
	}
}
