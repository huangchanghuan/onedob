...
public class TimeAssemble extends AbstractAssemble{
	...
	public Object setFieldValue(ResultSet rs, Object entity, Field f,
		...
		Object value = rs.getTime(colname);
		this.setFieldValue(entity, f, value);
		return value;
	}
}
