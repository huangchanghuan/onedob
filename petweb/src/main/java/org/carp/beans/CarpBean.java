 ...
 * @since 0.1
 */
public class CarpBean implements Cloneable{
	...
	@Override
	public CarpBean clone() throws CloneNotSupportedException {
		TableMetadata metadata = this.table.clone();
		return new CarpBean(metadata);
	}
	/**
	 * 取得实体的主键值
	 * @param entity
	 * @return
	 */
	public Serializable getPrimaryValue(Object entity){
	 ...
	 * @return
	 */
	public Serializable getPrimaryValue(Object entity,String name){
