...
public class PrimarysMetadata extends Metadata implements Cloneable{
	...
	@Override
	protected PrimarysMetadata clone() throws CloneNotSupportedException {
		return (PrimarysMetadata)super.clone();
	}
}
