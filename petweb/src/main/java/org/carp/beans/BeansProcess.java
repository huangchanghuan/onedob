...
public class BeansProcess {
	public static CarpBean parser(Class<?> cls) throws CarpException{
		...
		if(bean.getColumns()==null && bean.getPrimarys() == null)
			throw new CarpException("表："+bean.getTable()+"没有定义Column！");
		return bean;
	}
}
