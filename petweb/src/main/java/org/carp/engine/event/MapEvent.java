...
public class MapEvent{
	private static final Logger logger = Logger.getLogger(MapEvent.class);
	...
	public MapEvent(AbstractCarpSession session,String table, Map<String,Object> map) throws Exception{
	...
	private void displaySql(){
		if(logger.isDebugEnabled())
			logger.debug(sql);
		if(session.getJdbcContext().getContext().getCarpSetting().isShowSql()){
